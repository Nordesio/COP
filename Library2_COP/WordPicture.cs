...
{
    public partial class WordPicture : Component
    {
        public WordPicture()
        {
            InitializeComponent();
        ...
        public WordPicture(IContainer container)
        {
            container.Add(this);
     ...
     paragraphProperties)
        ...
        public void InsertAPicture(string document, string title, List<String> fileName)
        {
            ...
            using (WordprocessingDocument wordprocessingDocument = WordprocessingDocument.Create(document, WordprocessingDocumentType.Document))
            {
                ...
                if (fileName == null)
                {
                    throw new Exception("Картинок нет!");
                }
